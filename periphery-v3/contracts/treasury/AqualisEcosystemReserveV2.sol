...
/**
 * @title AqualisEcosystemReserve v2
 ...
 * Modifications:
 * - Sablier "pulls" the funds from the creator of the stream at creation. In the Aqualis case, we already have the funds.
 * - Anybody can create streams on Sablier. Here, only the funds admin (Aqualis governance via controller) can
 ...
 * @author BGD Labs
 **/
contract AqualisEcosystemReserveV2 is
