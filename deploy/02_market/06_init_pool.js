...
const func = async function ({ getNamedAccounts, deployments, ...hre }) {
    ...
    const addressesProviderInstance = (await (0, tx_1.getContract)("PoolAddressesProvider", addressesProvider));
    ...
    const poolConfiguratorInstance = await (0, contract_getters_1.getPoolConfiguratorProxy)();
