...
const getReserveAddresses = async (poolConfig, network) => {
    ...
    if (isLive && !poolConfig.TestnetMarket) {
        ...
        return (0, exports.getRequiredParamPerNetwork)(poolConfig, "ReserveAssets", network);
    }
...
const getChainlinkOracles = async (poolConfig, network) => {
    ...
    if (isLive) {
        ...
        return (0, exports.getRequiredParamPerNetwork)(poolConfig, "ChainlinkAggregator", network);
    }
...
const getReserveAddress = async (poolConfig, symbol) => {
    ...
    if (isZeroOrNull && (0, exports.isTestnetMarket)(poolConfig)) {
